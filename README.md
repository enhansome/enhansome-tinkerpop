...
* [JanusGraph](https://github.com/JanusGraph/janusgraph) ⭐ 5,837 | 🐛 599 | 🌐 Java | 📅 2026-09-14 - JanusGraph: an open-source, distributed graph database <http://janusgraph.org>
* [TinkerPop3 implementation](https://github.com/apache/tinkerpop) ⭐ 2,146 | 🐛 32 | 🌐 Java | 📅 2026-09-14 - Mirror of Apache TinkerPop.
