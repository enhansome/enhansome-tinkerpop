...
* [JanusGraph](https://github.com/JanusGraph/janusgraph) ⭐ 5,840 | 🐛 583 | 🌐 Java | 📅 2026-09-22 - JanusGraph: an open-source, distributed graph database <http://janusgraph.org>
* [TinkerPop3 implementation](https://github.com/apache/tinkerpop) ⭐ 2,146 | 🐛 34 | 🌐 Java | 📅 2026-09-18 - Mirror of Apache TinkerPop.
