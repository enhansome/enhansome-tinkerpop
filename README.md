...
* [JanusGraph](https://github.com/JanusGraph/janusgraph) ⭐ 5,828 | 🐛 596 | 🌐 Java | 📅 2026-08-18 - JanusGraph: an open-source, distributed graph database <http://janusgraph.org>
* [TinkerPop3 implementation](https://github.com/apache/tinkerpop) ⭐ 2,143 | 🐛 33 | 🌐 Java | 📅 2026-08-18 - Mirror of Apache TinkerPop.
