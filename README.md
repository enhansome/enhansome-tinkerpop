...
* [JanusGraph](https://github.com/JanusGraph/janusgraph) ⭐ 5,839 | 🐛 592 | 🌐 Java | 📅 2026-09-21 - JanusGraph: an open-source, distributed graph database <http://janusgraph.org>
* [TinkerPop3 implementation](https://github.com/apache/tinkerpop) ⭐ 2,146 | 🐛 33 | 🌐 Java | 📅 2026-09-18 - Mirror of Apache TinkerPop.
