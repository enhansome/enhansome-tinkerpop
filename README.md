...
* [JanusGraph](https://github.com/JanusGraph/janusgraph) ⭐ 5,836 | 🐛 598 | 🌐 Java | 📅 2026-08-18 - JanusGraph: an open-source, distributed graph database <http://janusgraph.org>
* [TinkerPop3 implementation](https://github.com/apache/tinkerpop) ⭐ 2,145 | 🐛 31 | 🌐 Java | 📅 2026-09-11 - Mirror of Apache TinkerPop.
